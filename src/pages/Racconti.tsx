  ...
  <div className="bg-background py-16 md:py-20">
    ...
    <div className="editorial-container space-y-16 md:space-y-20">
      ...
      <section aria-label="Le tre voci dei racconti" className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <Link
          to="/editoriale"
          className="md:col-span-7 border-2 border-foreground bg-background flex flex-col justify-between p-8 md:p-10 shadow-brutalist hover:shadow-brutalist-aqua hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all group"
        >
          <div>
            <h2 className="editorial-subheading mb-4">Editoriale</h2>
            <p className="editorial-body text-foreground/80 max-w-md">
